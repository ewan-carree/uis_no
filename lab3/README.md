...
Please refer to [our guide](https://github.com/dat320-2022/info/blob/main/setup-go.md) for installing Go.
See our [editors guide](https://github.com/dat320-2022/info/blob/main/setup-editors.md) for setting up a text editor/IDE for development.
...
Before you start working on the assignments below, make sure that your local working copy has all the latest changes from the course [assignments](https://github.com/dat320-2022/assignments) repository.
Instructions for fetching the latest changes are [here](https://github.com/dat320-2022/info/blob/main/lab-submission.md#update-local-working-copy-from-course-assignments).
...
9. When you are done with all assignments and want to submit the final version, please follow these [instructions](https://github.com/dat320-2022/info/blob/main/lab-submission.md#final-submission-of-labx).
