...
5. If the remote repositories are set up as in the following segment, how would you pull changes from the `dat320-2022/assignments` repo into the `dat320-2022/student-labs` repo you are working in?
    ...
    origin              git@github.com:dat320-2022/student-labs.git (fetch)
    origin              git@github.com:dat320-2022/student-labs.git (push)
    ```

    - [ ] a) `git pull dat320-2022/assignments.git dat320-2022/student-labs.git`
